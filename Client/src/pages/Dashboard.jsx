  ...
  const modules = [
    ...(isMCA
      ? [
          {
            title: "Add Examiner",
            description: "Add examiners with designation, rate, and bank details.",
            icon: "👤",
            path: "/add-examiner",
          },
        ]
    ...
    {
      title: "Summary",
      description: "View a consolidated summary of all payments with filters and export.",
      icon: "📊",
      path: "/summary",
    },
  ];
    ...
    <DashboardLayout>
      <div className="p-8">
        ...
        <p className="text-slate-600 mb-8">
          Use the cards below or the sidebar menu to manage exam duty
          payments and view summary reports.
        </p>
